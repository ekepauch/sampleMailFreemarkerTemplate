...
<head>
    ...
    <title>Notification 5 - Responsive Email Template
    </title>
    ...
    <style type="text/css">
        body{
            ...
            background-image: url(C:\Users\Victor\Desktop\green.jpg);
        }
        p,h1,h2,h3,h4{
            margin-top:0;
            margin-bottom:0;
...
<!-- ======= main section ======= -->
<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="187b19" style="background-image: ); background-size: 100% 100%; background-position: top center;" background="">
    <tr>
        <td height="90" style="font-size: 90px; line-height: 90px;">&nbsp;
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <table border="0" align="center" width="510" cellpadding="0" cellspacing="0" bgcolor="#fffff" class="container590 bodybg_color" style="border-radius: 4px;">
                <tr>
                ...
                <tr>
                    <td align="center" style="color: #192718; font-size: 20px; font-family: 'Oxygen', sans-serif; mso-line-height-rule: exactly; line-height: 30px;" class="title_color main-header">
                        <!-- ======= section header ======= -->
                ...
                <tr>
                    <td>
                        <table border="0" width="440" align="center" cellpadding="0" cellspacing="0" class="container580">
                            <tr>
                                <td align="center" style="color: #8d94a3; font-size: 16px; font-family: 'Oxygen', sans-serif; mso-line-height-rule: exactly; line-height: 24px;text-align:left" class="resize-text text_color">
